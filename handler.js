...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.img = 'https://bbx.my.id/images/ico.png'
        global.fla = pickRandom(global.flaaa)
        global.namabot = conn.user.name
        global.packname = '© Fn4ticHzBOT'
        global.author = 'Made By RamaGans ID © 2022'
        global.packname2 = 'Made With'
        global.author2 = 'RamaGans ID © 2022'
        global.wm3 = '·͟͟͟͟͟͟͞͞͞͞͞͞Made By Fn4ticHzBOT˚'
        global.wm2 = '© Fn4ticHzBOT' + ' ' + 'RamaGans ID'
        global.wm = '© Fn4ticHzBOT'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'By Fn4ticHzBOT'
        global.kontak2 = [
        ['6283831807003', 'RamaGans ID', 'Creator Bot', 'r00t@mail.nieuws.my.id', true],
        ['6281326284093', 'Fn4ticHzBOT', 'Bot WhatsApp', 'Just Bot', true]
        ]
            ...
            case 'remove':
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        let pp = 'https://bbx.my.id/images/ico.png'
                        try {
                            ...
                            let lea = API('hardianto', '/api/goodbye3', {
                                ...
                                bg: 'https://bbx.my.id/images/ico.png',
...
global.thumb = 'https://bbx.my.id/images/ico.png'
