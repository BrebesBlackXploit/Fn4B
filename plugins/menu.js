 ...
 *Powered By @${'6283831807003'.split('@')[0]}*`
    let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender
     let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://bbx.my.id/images/ico.png")
 ...
   "productImage":{ 
   "mimetype": "image/jpeg", 
   "jpegThumbnail": await (await fetch('https://bbx.my.id/images/ico.png')).buffer(), //Gambarnye
     }, 
   "title": `${ucapan()}`, 
 ...
 const fload = {
    ...
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://bbx.my.id/images/ico.png')).buffer(), //Gambarnye
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `Fn4ticHzBOT By RamaGans ID`, 
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://bbx.my.id/images/ico.png')).buffer(), //Gambarnye
    sellerJid: '0@s.whatsapp.net' 
    }
 ...
     }) 
     if (teks == '404') {
  let cute = await conn.resize(await (await fetch(`https://bbx.my.id/images/ico.png`)).buffer(), 300, 200) 
  let ori = `┏━━━ꕥ〔 *${botname}* 〕ꕥ━⬣
...
┃✾ Youtube:
┃✾ https://youtube.com/BrebesBlackXploit
┗━━━━━━ꕥ
...
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah Fory : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow Tiktok My Bestie'])}`, sourceUrl: 'https://www.tiktok.com/@raraharsita2', thumbnail: await (await fetch('https://i.ibb.co/jfZVKmC/babi2.jpg')).buffer(),}} 
 ...
   if (lgs >= 4) { 
     imp = 'https://bbx.my.id/images/ico.png' 
   } 
   if (lgs > 10) { 
     imp = 'https://bbx.my.id/images/ico.png' 
   } 
 ...
   res = "Selamat dinihari" 
   if (varel >= 4) { 
     dimrel = 'https://bbx.my.id/images/ico.png' 
   } 
   if (varel > 10) { 
     dimrel = 'https://bbx.my.id/images/ico.png' 
   } 
 ...
     mask = await jimp.read('https://bbx.my.id/images/ico.png'), 
     welcome = await jimp.read(thumbnailUrl.getRandom()), 
     avatar = await jimp.read(await conn.profilePictureUrl(m.sender, 'image').catch(() => 'https://bbx.my.id/images/ico.png')), 
