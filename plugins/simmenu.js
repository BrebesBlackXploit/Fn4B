...
const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text":`Fn4ticHzBOT ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `Fn4ticHzBOT ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 'jpegThumbnail': await conn.resize(await (await fetch('https://bbx.my.id/images/ico.png')).buffer(), 300, 250)                        
                  }	                  
                   } 
                     }
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ Fn4ticHzBOT",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ Fn4ticHzBOT",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ Fn4ticHzBOT",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di Fn4ticHzBOT",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
